...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            'AI가 학습자의 취약점을 분석하고 미래 정오답률을 예측하여 개인화된 학습 경험을 제공하는 크로스플랫폼 모바일 앱 서비스',
        tech: [
            'Flutter',
            'Dart',
            'GetX',
        ...
        detailedDescription:
            'Flutter 기반의 크로스플랫폼(iOS/Android) 모바일 앱 서비스로, AI가 학습자의 취약점을 분석하고 미래 정오답률을 예측하여 개인화된 학습 경험을 제공하는 9급 공무원 시험 대비 교육 플랫폼입니다. 기획 초기 단계부터 참여하여 앱(Front-end), 메인 API 서버(Back-end), AI 예측 API 서버(AI)의 설계, 개발, 배포, 운영까지 전 과정에 핵심적인 역할을 수행했습니다.',
        features: [
            'AI 진단시험, 단원별 학습, 오답노트, 복습 문항 제공',
            'DKT 예측값 기반 사용자의 학습 성취도 분석 및 시각화',
            '다양한 인증 방식(이메일, 소셜, 게스트) 및 계정 연동 지원',
            'FCM 기반 학습 독려 푸시 알림 시스템',
        ],
        contributions: [
            {
                ...
                details: [
                    ...
                    '데이터베이스 관리의 유연성 향상을 위해 기존 MyBatis(XML) 기반의 데이터 접근 방식을 TypeORM으로 전환하고, 복잡한 쿼리는 Raw Query를 활용하여 성능을 확보하며 안정적인 데이터 마이그레이션을 완료했습니다.',
                ],
            },
            {
    ...
    },
    {
        ...
        tech: ['Vue.js', 'CesiumJS'],
        thumbnail: '1.png',
        category: ['프론트엔드', '관제 시스템', '3D 지도'],
        detailedDescription:
            '웹 환경에서 다수의 드론을 동시에 관제하고 임무를 할당하는 WGCS(Web Ground Control System)의 프론트엔드 시스템을 개발했습니다. CesiumJS(3D 지도 라이브러리)를 기반으로 지도 위에 드론의 임무 경로, 안전 비행 구역 등을 설정하고 모니터링하는 기능을 구현했습니다.',
        features: [
        ...
        contributions: [
            ...
            },
            {
                ...
                details: [
                    '드론의 안전 비행 구역 설정을 위해 지도 위에 Polygon, Circle 등 다양한 형태의 가상 울타리(Geofence)를 설정하고, 좌표 기반으로 세밀하게 제어하는 기능을 주도적으로 개발하여 관제 안정성을 확보했습니다.',
                ],
            },
            {
        ...
        troubleShooting: [
            {
                ...
                details: [
                    '[문제점] 드론 관제 환경은 대형 모니터부터 일반 노트북까지 다양했기 때문에, 여러 해상도에서 UI가 깨지거나 조작이 어려운 문제가 발생했습니다.',
                    '[해결] 5가지 주요 해상도(2560px ~ 1280px)를 타겟으로 미디어 쿼리와 유연한 레이아웃 설계를 통해 각 해상도에 최적화된 반응형 UI를 구현했습니다. 이를 통해 어떤 환경에서도 일관되고 안정적인 관제 경험을 제공할 수 있었습니다.',
                ],
            },
            {
